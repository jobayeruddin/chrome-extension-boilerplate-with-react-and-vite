...
function vh(a) {
  ...
  function k2(a2, b2, c2, d2) {
    ...
    if (
      ...
      return (
        (d2 = e(b2, c2.props)), (d2.ref = sh(a2, b2, c2)), (d2.return = a2), d2
      );
      ...
      switch (f3.$$typeof) {
        case va:
          a: {
            ...
            f3.type === ya
              ? ((d2 = Ah(f3.props.children, a2.mode, h2, f3.key)),
                (d2.return = a2),
                (a2 = d2))
              : ((h2 = yh(f3.type, f3.key, f3.props, null, a2.mode, h2)),
                (h2.ref = sh(a2, d2, f3)),
                (h2.return = a2),
                (a2 = h2));
          }
...
function fi(a) {
  ...
  if (null !== a) {
    e = a;
    do (f2 = e.lane), (N.lanes |= f2), (hh |= f2), (e = e.next);
    while (e !== a);
...
function Di(a, b, c) {
  if (0 === (Rh & 21))
    return (
      a.baseState && ((a.baseState = false), (Ug = true)), (a.memoizedState = c)
    );
...
function ij(a, b, c, d, e) {
  ...
  if (null === b.stateNode) jj(a, b), ph(b, c, d), rh(b, c, d, e), (d = true);
    ...
    q2 ||
      ...
      ((h !== d || k2 !== l2) && qh(b, g, d, l2));
    $g = false;
    var r2 = b.memoizedState;
    g.state = r2;
    gh(b, d, g, e);
    k2 = b.memoizedState;
    h !== d || r2 !== k2 || Wf.current || $g
      ? ("function" === typeof m2 && (kh(b, c, m2, d), (k2 = b.memoizedState)),
        (h = $g || oh(b, c, h, d, r2, k2, l2))
          ? (q2 ||
    ...
    (m2 =
      ...
      ("function" !== typeof g.UNSAFE_componentWillReceiveProps &&
        "function" !== typeof g.componentWillReceiveProps) ||
      ((h !== q2 || r2 !== k2) && qh(b, g, d, k2));
    $g = false;
    r2 = b.memoizedState;
    g.state = r2;
    gh(b, d, g, e);
    var n2 = b.memoizedState;
    h !== q2 || r2 !== n2 || Wf.current || $g
      ? ("function" === typeof y2 && (kh(b, c, y2, d), (n2 = b.memoizedState)),
        (l2 = $g || oh(b, c, l2, d, r2, n2, k2) || false)
          ? (m2 ||
...
function kj(a, b, c, d, e, f2) {
  hj(a, b);
  var g = 0 !== (b.flags & 128);
  if (!d && !g) return e && dg(b, c, false), $i(a, b, f2);
  d = b.stateNode;
  Xi.current = b;
  var h =
  ...
  b.flags |= 1;
  null !== a && g
    ? ((b.child = Bh(b, a.child, null, f2)), (b.child = Bh(b, null, h, f2)))
    : Yi(a, b, h, f2);
  ...
  if (f2) {
    ...
    0 === (g & 1) && b.child !== e
      ? ((d = b.child),
        ...
        (d.pendingProps = k2),
        (b.deletions = null))
      : ((d = wh(e, k2)), (d.subtreeFlags = e.subtreeFlags & 14680064));
    null !== h
      ? (f2 = wh(h, f2))
      : ((f2 = Ah(f2, g, c, null)), (f2.flags |= 2));
    f2.return = b;
    d.return = b;
    d.sibling = f2;
    b.child = d;
...
function sj(a, b, c, d, e, f2, g) {
  ...
  if (Ug || h) {
    ...
    if (null !== d) {
      ...
      0 !== e &&
        e !== f2.retryLane &&
        ((f2.retryLane = e), Zg(a, e), mh(d, a, e, -1));
    }
    uj();
    d = Li(Error(p(421)));
    return tj(a, b, g, d);
...
function Fj(a, b, c) {
  ...
  switch (b.tag) {
    ...
    case 4:
      return (
        Jh(), Bj(a, b), null === a && sf(b.stateNode.containerInfo), S(b), null
      );
    case 10:
    ...
    case 19:
      ...
      if (null === g)
        if (d) Ej(f2, false);
          ...
          null !== f2.tail &&
            B() > Hj &&
            ((b.flags |= 128), (d = true), Ej(f2, false), (b.lanes = 4194304));
        }
      else {
        if (!d)
          if (((a = Mh(g)), null !== a)) {
                ...
                if (null !== n2) {
                  var t2 = n2.memoizedProps,
                    ...
                    w2 = x2.getSnapshotBeforeUpdate(
                      b.elementType === b.type ? t2 : Lg(b.type, t2),
                      J2
                    );
    ...
    case 15:
      if (
        ...
        do {
          ...
          f2 = f2.tag;
          void 0 !== g &&
            (0 !== (f2 & 2) ? Nj(c, b, g) : 0 !== (f2 & 4) && Nj(c, b, g));
          e = e.next;
        } while (e !== d);
      }
      Zj(a, b, c);
  ...
  if (0 !== b) {
    ...
    if (6 === b) Dk(a, d);
      ...
      if (
        ...
        !Pk(e) &&
        ((b = Jk(a, d)),
        2 === b && ((f2 = xc(a)), 0 !== f2 && ((d = f2), (b = Ok(a, f2)))),
        1 === b)
      )
    ...
    case 2:
      ...
      void 0 === e.$$typeof
        ? ((b.tag = 1),
          ...
          (e._reactInternals = b),
          rh(b, d, a, c),
          (b = kj(null, b, d, true, f2, c)))
        : ((b.tag = 0), I && f2 && vg(b), Yi(null, b, e, c), (b = b.child));
      return b;
    case 16:
      d = b.elementType;
      a: {
  ...
  switch (a.tag) {
    case 3:
      ...
      if (b.current.memoizedState.isDehydrated) {
        ...
        0 !== c &&
          (Cc(b, c | 1), Ek(b, B()), 0 === (K & 6) && ((Hj = B() + 500), jg()));
      }
      break;
    case 13:
      Sk(function () {
...
//export { React as R, client as c, jsxRuntimeExports as j, reactExports as r };
